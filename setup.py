...
objects = [
    Planet(
        name="1", diameter=1, mass=1,
        position=Vector.from_cartesian(-1, 0),
        velocity=Vector.from_cartesian(1, 0)
        ),
    Planet(
        name="2", diameter=1, mass=1,
        position=Vector.from_cartesian(3, .5),
        velocity=Vector.from_cartesian(-1, 0)
        )
]
...
objects3 = [
    Planet(
        name="1", diameter=0.5, mass=2, position=Vector.from_cartesian(-1, 0),
        velocity=Vector.from_polar(angle=0, length=1)
        ),

    Planet(name="2", diameter=0.5, mass=2, position=Vector.from_cartesian(0, 0)),
...
objects4 = [
    Planet(
        name="1", diameter=1.2, mass=4, position=Vector(),
        velocity=Vector.from_cartesian(1, -1)
        ),
    Planet(
        name="2", diameter=1, mass=2, position=Vector.from_cartesian(0, -3),
        velocity=Vector.from_cartesian(1, 0)
        )
]
